...
const SCRIPT_TARGETS = {
  ...
  "validate:skill-popup": "server/validate-skill-point-popup.js",
...
const SUITES = {
  ...
  gameplay: ["validate:boss", "validate:spawn-scale", "validate:xp-pacing", "validate:tactics", "validate:minotaur", "validate:solo-xp", "validate:skill-refund", "validate:skill-popup", "validate:player-death-healing", "validate:dev-start"],
  lighting: [
  ...
  "pre-commit": ["check", "validate:loc", "validate:boss", "validate:spawn-scale", "validate:xp-pacing", "validate:tactics", "validate:minotaur", "validate:solo-xp", "validate:skill-refund", "validate:skill-popup", "validate:player-death-healing", "validate:dev-start"],
  closeout: [
    "check",
    "validate:loc",
    "validate:boss",
