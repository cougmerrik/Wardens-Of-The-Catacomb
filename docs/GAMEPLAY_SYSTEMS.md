...
- The shop pool includes tactical utility consumables such as Lantern Fuel, Darkvision Potion, and Holy Candle. Lantern Fuel refills the purchaser's lantern by 20%, Darkvision Potion privately gives the consumer 10 tiles of dark sight for 30 seconds, and Holy Candle drops a 3-tile holy light for 10 seconds that heals players inside for 5% max health each second. Spike Growth is charge-based, retaliating for the next 25 hits instead of expiring by time.
