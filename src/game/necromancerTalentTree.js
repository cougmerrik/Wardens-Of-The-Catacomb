...
const MAGE_TALENT_DEFS = [
  ...
  { key: "frozenOrbCantrip", label: "Frozen Orb", tier: 1, group: "cantrip", maxRanks: 1, icon: "FO", color: "#9edcff", description: ["Cantrip. Fires a slow cold orb with lower direct frost damage.", "The orb pulses smaller shards that Chill enemies, slowing them by 30%."] },
